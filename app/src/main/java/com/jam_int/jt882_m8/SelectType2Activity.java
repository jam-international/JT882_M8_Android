...
public class SelectType2Activity extends AppCompatActivity {
    ...
    public void BtnNext(View v) {
        ...
        if (vf.getDisplayedChild() == 0 || vf.getDisplayedChild() == 1 || vf.getDisplayedChild() == 2 || vf.getDisplayedChild() == 3) {
