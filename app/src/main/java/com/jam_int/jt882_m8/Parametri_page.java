...
public class Parametri_page extends Activity {
    ...
    MultiCmdItem MultiCmd_Vb1012, MultiCmd_Vq1701, MultiCmd_Vq1702, MultiCmd_Vq1703, MultiCmd_Vq1704, MultiCmd_Vq1705, MultiCmd_Vq1706, MultiCmd_Vq1707,
            ...
            Multicmd_HMI_C1_UdfVelLavRPM,Multicmd_Vb23,Multicmd_Vb24,Multicmd_Vn120_ClampMode,Multicmd_Vb170KitTascaCargo,Multicmd_Vb151EnableCarPattine,MultiCmd_Vq3079,MultiCmd_Vq3092,MultiCmd_Vq3093,
...
*/
       ...
       // Mci_write_Vq3511_VelLavCaricatore.mci = Multicmd_Vq3511;
        ...
        mci_array_read_all_1 = new MultiCmdItem[]{
                ...
                MultiCmd_Vq3071, MultiCmd_Vq3085, Multicmd_Vq3054, Multicmd_Vq3084_SpostamentoPinzaPezziCorti,Multicmd_vb20,Multicmd_Vb23,Multicmd_Vb24,Multicmd_Vn120_ClampMode,Multicmd_Vb170KitTascaCargo,
    ...
    private void Inizializza_parametri() {
        ...
        switch (Chiamante) {
            ...
            case PAGE_C1_PARAM:
                ...
                Lista_parametri.add(new Parametro_mac(Multicmd_vq1720, 13, 0, 360, 230, false, false, true, true, false, true, false, new ArrayList<>(), new ArrayList<>(), null, false, 0.0d,false,0));
                Lista_parametri.add(new Parametro_mac(Multicmd_vq1721, 14, 0, 360, 240, false, false, true, false, false, true, false, new ArrayList<>(), new ArrayList<>(), null, false, 0.0d,false,0));
            ...
            case PAGE_C2_PARAM:
                ...
                Lista_parametri.add(new Parametro_mac(Multicmd_vq2718, 11, 0, 360, 110, false, false, true, true, false, true, false, new ArrayList<>(), new ArrayList<>(), null, false, 0.0d,false,0));
                Lista_parametri.add(new Parametro_mac(Multicmd_vq2719, 12, 0, 360, 250, false, false, true, false, false, true, false, new ArrayList<>(), new ArrayList<>(), null, false, 0.0d,false,0));
                Lista_parametri.add(new Parametro_mac(Multicmd_vq2720, 13, 0, 360, 230, false, false, true, true, false, true, false, new ArrayList<>(), new ArrayList<>(), null, false, 0.0d,false,0));
                Lista_parametri.add(new Parametro_mac(Multicmd_vq2721, 14, 0, 360, 240, false, false, true, false, false, true, false, new ArrayList<>(), new ArrayList<>(), null, false, 0.0d,false,0));
                ...
                Lista_parametri.add(new Parametro_mac(Multicmd_Vb24, 21, 0, 1, 0, true, false, false, false, true, true, false, new ArrayList<>(), new ArrayList<>(), null, false, 0.0d,false,0));
